...
Public Class Login_Manager
    ...
    Private Sub btnLogin_Click(sender As Object, e As EventArgs) Handles btnLogin.Click
        Dim pnl As New Menu_Manager(Form1)
        ...
        If dr.HasRows = True And cb_jabatan.SelectedItem = "Manager" Then
            pnl.swipe(True)
            Me.Hide()
        Else
    ...
    Private Sub Login_Manager_Load(sender As Object, e As EventArgs) Handles MyBase.Load
